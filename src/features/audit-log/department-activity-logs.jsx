  ...
  const renderContent = () => {
    ...
    const columns = [
...

      {
        ...
        body: (rowData) => (
          <span style={{ textAlign: "left" }}>{rowData.content || "-"}</span>
        ),
      },
      {
        field: "timestamp",
      ...
      import("jspdf").then((jsPDFModule) => {
        import("jspdf-autotable").then(() => {
          ...
          try {
            ...
            doc.save("department-activity-logs.pdf");
          } catch (error) {
    ...
    const exportExcel = () => {
      import("xlsx").then((xlsx) => {
        ...
        saveAsExcelFile(excelBuffer, "department-activity-logs");
      });
    };
...
export default DepartmentActivityLogs;
